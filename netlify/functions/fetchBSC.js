...
exports.handler = async (event) => {
    ...
    const apiKey = process.env.BSC_API_KEY; // Ensure you have BSC_API_KEY set in your environment variables
        ...
        if (result.status === "1") {
            ...
            return {
                ...
                headers: {
                    ...
                    "Access-Control-Allow-Origin": "*", // This allows all domains, adjust as needed for security
